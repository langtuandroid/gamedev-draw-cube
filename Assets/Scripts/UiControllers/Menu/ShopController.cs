...
namespace UI
{
    public class ShopController : MonoBehaviour
    {
        ...
        [SerializeField] private TextMeshProUGUI _inGameCurrencyText;
        [SerializeField] private TextMeshProUGUI _paidCurrencyText;
        ...
        void Start()
        {
            PlayerPrefsManager.ON_COINS_CHANGED += SetCurrencyTexts;
            SetCurrencyTexts();
            InitializeShop();
        }
        ...
        {
            _inGameCurrencyText.text = PlayerPrefsManager.GetInGameCurrency().ToString();
            _paidCurrencyText.text = PlayerPrefsManager.GetPaidCurrency().ToString();
        }
        ...
        private void OnSkinButtonClick(int skinIndex)
        {
            ...
            {
                case EWayToGetSkin.InGameCurrency:
                    
                    if (skinModel.Price > PlayerPrefsManager.GetInGameCurrency()) return;

                    PlayerPrefsManager.AddInGameCurrency(-skinModel.Price);
                    SetCurrencyTexts();
                ...
                case EWayToGetSkin.PaidCurrency:
