...
namespace UI
{
    public class ShopButtonController : MonoBehaviour
    {
        ...
        [SerializeField] private GameObject _inGameCurrencyIcon;
        [SerializeField] private GameObject _paidCurrencyIcon;
        ...
        public void Initialize(int skinIndex, SkinModel skinModel, bool isUnlocked, bool isEquipped, RenderTexture skinTexture, Action<int> onSkinButtonClick)
        {
            ...
            _inGameCurrencyIcon.SetActive(skinModel.WayToGetSkin == EWayToGetSkin.InGameCurrency);
            _paidCurrencyIcon.SetActive(skinModel.WayToGetSkin == EWayToGetSkin.PaidCurrency);
